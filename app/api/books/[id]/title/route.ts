...
export async function PATCH(
  ...
  try {
    ...
    try {
      ...
      if (!canEdit) {
        return NextResponse.json({ error: "You don't have permission to edit this book" }, { status: 403 });
      }
    ...
    if (updateError) {
      ...
      return NextResponse.json({ error: "Failed to update book title" }, { status: 500 });
    }
